...
class SchedulerModule {
	...
	public:
		...
		bool reconfigureParameters(services::ParameterReconfiguration::Request &req, services::ParameterReconfiguration::Response &res);
	...
	private:
		...
		ros::ServiceServer scheduler_service, reconfiguration_service;
